...
apt-get install apache2 php php-mysqli php-mysql php-gd php-mbstring python -y > /dev/null 2>&1
...
procss2=`netstat -nplt |grep 'badvpn' | awk {'print $4'} | cut -d: -f2 |xargs`
if [ -n "$procss" ]; then
...
def main(host=IP, port=PORT):
    print "\033[0;34mÃ¢â€Â"*8,"\033[1;32m PROXY SOCKS","\033[0;34mÃ¢â€Â"*8,"\n"
    print "\033[1;33mIP:\033[1;32m " + IP
    print "\033[1;33mPORTA:\033[1;32m " + str(PORT) + "\n"
    print "\033[0;34mÃ¢â€Â"*10,"\033[1;32m SSHPLUS","\033[0;34mÃ¢â€Â\033[1;37m"*11,"\n"
...
apt-get install sudo mysql-client nano unzip build-essential curl build-essential libwrap0-dev libpam0g-dev libdbus-1-dev libreadline-dev libnl-route-3-dev libprotobuf-c0-dev libpcl1-dev libopts25-dev autogen libgnutls28-dev libseccomp-dev libhttp-parser-dev php libapache2-mod-php -y
...
echo -e "\n  \033[1;32mInstalling SOcks !\033[0m"
fun_bar 'socks'
...
echo -e "\n  \033[1;32mInstalling BadVPN !\033[0m"
fun_bar 'badvpn'
